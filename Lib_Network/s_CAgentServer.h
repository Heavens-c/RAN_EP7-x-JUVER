...
#include "../Lib_Engine/Utils/ExceptionHandler.h"

#include "../Lib_Engine/G-Logic/DxMsgServer.h"

#include "../Lib_Client/DbActionLogic.h"
...
{
public :
	CAgentServer( HWND hWnd, HWND hEditBox, HWND hEditBoxInfo, HWND hEditBoxStats );
	~CAgentServer();
...
public:
	...
	*/
	...
	void MsgCharSelectPass ( MSG_LIST* pMsg );
	void MsgCharSelectPassBack ( NET_CHARSELECT_PASS_FEEDBACK_DATA2* nlfd2 );
...
public:
	...
	void RegisterInit( MSG_LIST* pMsg );
	void RegisterAction( MSG_LIST* pMsg );
	void RegisterFeedback( NET_REGISTER_ACTION_FB2* fb2 );
