...
public:
	...
	virtual void WriteStats( const TCHAR* msg, ... );
	virtual void WriteStats( int nType, const TCHAR* msg, ... );
	...
	void UpdateEditControlStats( TCHAR* msgbuf );
	void SetControl( HWND hControl, HWND hControlInfo, HWND hControlStats );
	HWND GetControl();
