...
namespace DXPARAMSET
{
	...
	void LOADDATA ()
	{
		...
		GetInstance().m_bDIS_RIDE = RANPARAM::bDIS_RIDE;
//		GetInstance().m_bDIS_FRIEND = RANPARAM::bDIS_FRIEND;		
		...
		GetInstance().m_bFrameLimit = FALSE;

		GetInstance().m_bClickEffect = RANPARAM::bClickEffect;
		GetInstance().m_bTargetEffect = RANPARAM::bTargetEffect;
		GetInstance().m_bMineEffect = RANPARAM::bMineEffect;
		GetInstance().m_dwTextureFilter = RANPARAM::dwTextureFilter;
	}
	...
	void STESTSET::VideoOK( CD3DApplication *pD3dApp )
	{
		...
		RANPARAM::bClickEffect = m_bClickEffect;
		RANPARAM::bTargetEffect = m_bTargetEffect;
		RANPARAM::bMineEffect = m_bMineEffect;
		RANPARAM::dwTextureFilter = m_dwTextureFilter;
	...
	void STESTSET::GameOK()
	{
		...
		RANPARAM::bDIS_RIDE = m_bDIS_RIDE;
	...
	void STESTSET::CANCEL ( CD3DApplication *pD3dApp )
	{
		...
		m_bDIS_RIDE = RANPARAM::bDIS_RIDE;
//		m_bDIS_FRIEND = RANPARAM::bDIS_FRIEND;
		...
		m_bClickEffect = RANPARAM::bClickEffect;
		m_bTargetEffect = RANPARAM::bTargetEffect;
		m_bMineEffect = RANPARAM::bMineEffect;
		m_dwTextureFilter = RANPARAM::dwTextureFilter;
