...
#define SESSION_CHECK_TIME		 30000// 1000 * 60 * 5 Session ���� üũ 5��
...
protected:
	...
	HWND				m_hEditBoxStats;		// Main window, Stats EditBox handle
...
public :
	...
	virtual	int	StartClientManager() = 0;
			...
			int GetTypeServer()		{ return m_nServerType;	}
