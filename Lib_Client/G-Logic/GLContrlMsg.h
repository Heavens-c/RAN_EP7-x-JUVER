...
#include "GLContrlPassengerMsg.h"
#include "GLAutoSystem/GLAutoSystemMsg.h"
...
enum EMCHAT_LOUDSPEAKER
{
	...
	EMCHAT_LOUDSPEAKER_DISABLED	= 4, /*megaphone set, Juver, 2018/01/02 */
};
...
namespace GLMSG
{
	...
	struct SNETPC_REQ_CLOSE_CLIENT_AGT
	{
		NET_MSG_GENERIC	nmg;
		
		DWORD dwGaeaID;

		SNETPC_REQ_CLOSE_CLIENT_AGT()
			: dwGaeaID(GAEAID_NULL)
		{
			nmg.dwSize	= sizeof(*this);
			nmg.nType	= NET_MSG_GCTRL_REQ_CLOSE_CLIENT_AGT;
