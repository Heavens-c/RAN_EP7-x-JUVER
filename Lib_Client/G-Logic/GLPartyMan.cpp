		...
		if ( pParty->ISCONFTING() )
		{
			...
			if ( bCONFT_END && bCONFT_SCHOOL )
			{
				...
				if ( emEND_B==EMCONFRONT_END_PWIN )
				{
					...
					GLMSG::SNET_EMCONFRONT_END_PWIN NetMsgConftEndPwin;
					StringCchCopy ( NetMsgConftEndPwin.szMapName, CHAR_SZNAME, szMAP_NAME );	
					StringCchCopy ( NetMsgConftEndPwin.szGuild1, CHAR_SZNAME, GLCONST_CHAR::GETSCHOOLNAME(wSCHOOL_A) );	
					StringCchCopy ( NetMsgConftEndPwin.szGuild2, CHAR_SZNAME, GLCONST_CHAR::GETSCHOOLNAME(wSCHOOL_B) );	
					StringCchCopy ( NetMsgConftEndPwin.szWinner, CHAR_SZNAME, GLCONST_CHAR::GETSCHOOLNAME(wSCHOOL_WIN) );	
					GLAgentServer::GetInstance().SENDTOALLCLIENT ( &NetMsgConftEndPwin );
				...
				else
				{
					...
					GLMSG::SNET_EMCONFRONT_END_PDRAWN NetMsgConftEndPDraw;
					StringCchCopy ( NetMsgConftEndPDraw.szMapName, CHAR_SZNAME, szMAP_NAME );	
					StringCchCopy ( NetMsgConftEndPDraw.szGuild1, CHAR_SZNAME, GLCONST_CHAR::GETSCHOOLNAME(wSCHOOL_A) );	
					StringCchCopy ( NetMsgConftEndPDraw.szGuild2, CHAR_SZNAME, GLCONST_CHAR::GETSCHOOLNAME(wSCHOOL_B) );	
					GLAgentServer::GetInstance().SENDTOALLCLIENT ( &NetMsgConftEndPDraw );
				}
