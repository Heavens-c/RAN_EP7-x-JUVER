...
void CPKRankNotificationInfo::CreateSubControl()
{
	...
	std::string strClassKiller[RANK_INFO_ICON_CLASS] = 
	{
		...
		"RANK_INFO_CHARACTER_CLASS_1_SCIENTIST_MALE",
		"RANK_INFO_CHARACTER_CLASS_1_SCIENTIST_FEMALE",
	};
	...
	std::string strClassKilled[RANK_INFO_ICON_CLASS] = 
	{
		...
		"RANK_INFO_CHARACTER_CLASS_2_SCIENTIST_MALE",
		"RANK_INFO_CHARACTER_CLASS_2_SCIENTIST_FEMALE",
	};
