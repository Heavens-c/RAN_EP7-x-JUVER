...
enum EMGLMSG
{
	...
	EMGLMSG_ACTIVITY_MAX	= 70, /*activity system, Juver, 2017/10/30 */
};

enum EMPASSENGER_ANS
{
	EMPASSENGER_OK				= 0,
	EMPASSENGER_CANCEL			= 1,
};

enum EMPASSENGER_CANCEL_TAR
{
	EMPASSENGER_CANCEL_NORMAL	= 0,	//	일반적인 취소.
	EMPASSENGER_CANCEL_OTHER	= 1,	//	상대편이 취소함.
};
...
enum EMCHAR_GATEOUT_FB
{
	...
	EMCHAR_GATEOUT_CLUBBATTLE_LOCK = 11, /*clubwar map lock, Juver, 2017/06/27 */
	EMCHAR_GATEOUT_OTHERCLUB_NOTALLOWED_INPARTY =  12,
};
...
enum EMSKILL_LEARNCHECK
{
	...
	EMSKILL_LEARN_OK = 0, // ¹e¿i±a ¼º°ø.
	EMSKILL_LEARN_MAX = 1, // ´o AI≫o ·¾¾÷A≫ CO ¼o ¾øA½.
	EMSKILL_LEARN_NOTTERM = 2, // ¿a±¸ A¶°CAI AæA·μCAo ¾E¾Æ¼­ ·¾¾÷A≫ CO¼o ¾øA½.
	EMSKILL_LEARN_NOTCLASS = 3, // ºI¼­°¡ Æ²·A¼­ ¹e¿i¼o ¾ø½A´I´U.
	EMSKILL_LEARN_NOTBRIGHT = 4, // ºu/¾I A¶°CAI AæA·μCAo ¾E½A´I´U.
	EMSKILL_LEARN_ALREADY = 5, // AI¹I ¹e¿i ½ºA³AO´I´U.
...
enum EMPARTY_LURE_FB
{
	...
	EMPARTY_LURE_OTHER_TEAM	= 7,	/*pvp capture the flag, Juver, 2018/02/03 */
};
...
enum EMTRADE_LOCK_FB
{
	EMTRADE_LOCK_OK		= 0,
	EMTRADE_LOCK_CANCEL	= 1,
};
