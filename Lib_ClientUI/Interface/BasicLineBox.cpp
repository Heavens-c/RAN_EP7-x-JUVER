...
//itemmall
void CBasicLineBox::CreateBaseBoxDialogueWhite ( char* szBoxControl )
{
	CreateBodyImage ( "BASIC_LINE_BOX_BODY_DIALOGUE_WHITE" );
	CreateLineImage ( "BASIC_LINE_BOX_LEFT_DIALOGUE_WHITE", "BASIC_LINE_BOX_RIGHT_DIALOGUE_WHITE", "BASIC_LINE_BOX_TOP_DIALOGUE_WHITE", "BASIC_LINE_BOX_BOTTOM_DIALOGUE_WHITE" );	
	ResizeControl ( szBoxControl );
}
...
void CBasicLineBox::CreateBaseBoxWhite ( char* szBoxControl )
{
	CreateBodyImage ( "BASIC_LINE_BOX_BODY_WHITE" );
	CreateLineImage ( "BASIC_LINE_BOX_LEFT_WHITE", "BASIC_LINE_BOX_RIGHT_WHITE", "BASIC_LINE_BOX_TOP_WHITE", "BASIC_LINE_BOX_BOTTOM_WHITE" );
	ResizeControl ( szBoxControl );
}

void CBasicLineBox::CreateBaseBoxWhiteBlankBody ( char* szBoxControl )
{
	//CreateBodyImage ( "BASIC_LINE_BOX_BODY_WHITE" );
	CreateLineImage ( "BASIC_LINE_BOX_LEFT_WHITE", "BASIC_LINE_BOX_RIGHT_WHITE", "BASIC_LINE_BOX_TOP_WHITE", "BASIC_LINE_BOX_BOTTOM_WHITE" );
	ResizeControl ( szBoxControl );
...
void CBasicLineBox::CreateBaseBoxManual ( char* szBoxControl, char* szBody, char* szLeft, char* szRight, char* szTop, char* szBottom )
{
	if ( !szBoxControl ){
		return;
	}
	...
	if ( szBody ){
		CreateBodyImage ( szBody );
	}

	if ( szLeft && szRight && szTop && szBottom ){
		CreateLineImage ( szLeft, szRight, szTop, szBottom );
	}
...
/////////////////////////////////////////////////////////////////////////////
// LG-7 GlobalRanking
void CBasicLineBox::CreateBaseBoxOuterBlank(char* szBoxControl)
{
	CreateBodyImage("BASIC_LINE_BOX_BODY_OUTER_BLANK");
	CreateLineImage("BASIC_LINE_BOX_LEFT_OUTER", "BASIC_LINE_BOX_RIGHT_OUTER", "BASIC_LINE_BOX_TOP_OUTER", "BASIC_LINE_BOX_BOTTOM_OUTER");
	ResizeControl(szBoxControl);
}

void CBasicLineBox::CreateBaseBoxOuterBlankWhite(char* szBoxControl)
{
	CreateBodyImage("BASIC_LINE_BOX_BODY_OUTER_BLANK_WHITE");
	CreateLineImage("BASIC_LINE_BOX_LEFT_OUTER_WHITE", "BASIC_LINE_BOX_RIGHT_OUTER_WHITE", "BASIC_LINE_BOX_TOP_OUTER_WHITE", "BASIC_LINE_BOX_BOTTOM_OUTER_WHITE");
	ResizeControl(szBoxControl);
}

void CBasicLineBox::CreateBaseBoxOuterWhite(char* szBoxControl)
{
	CreateBodyImage("BASIC_LINE_BOX_BODY_OUTER");
	CreateLineImage("BASIC_LINE_BOX_LEFT_OUTER_WHITE", "BASIC_LINE_BOX_RIGHT_OUTER_WHITE", "BASIC_LINE_BOX_TOP_OUTER_WHITE", "BASIC_LINE_BOX_BOTTOM_OUTER_WHITE");
	ResizeControl(szBoxControl);
