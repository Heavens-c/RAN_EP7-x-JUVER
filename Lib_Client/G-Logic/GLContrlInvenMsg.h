...
{
	ITEMSHOP_ITEM_GET_FB_FAIL		= 0,	//	�Ϲݿ���.
	ITEMSHOP_ITEM_GET_FB_OK		= 1,	//	����.
	ITEMSHOP_ITEM_GET_FB_NOITEM	= 2,	//	�������� ����.
	ITEMSHOP_ITEM_GET_FB_NOINVEN	= 3,	//	�κ����� ����.
};
...
enum EMREBUILD_RESULT	// ITEMREBUILD_MARK
{
	...
	EMREBUILD_RESULT_SUCCESS	= 2,	// Ȯ�� ��ư ������, ���� ����
	EMREBUILD_RESULT_DESTROY	= 3,	// Ȯ�� ��ư ������, ���� ����, ������ �Ҹ�
	EMREBUILD_RESULT_MONEY		= 4,	// Ȯ�� ��ư ������, �ݾ��� ���� �ʾƼ� ���� ����
...
namespace GLMSG
{
	...
	struct SNET_INVEN_SELFORMBOX_SELECTOPEN : public NET_MSG_GENERIC
	{
			...
			, nBoxPosY(-1)
		{
			...
			GASSERT(sizeof(SNET_INVEN_SELFORMBOX_SELECTOPEN)<=NET_DATA_BUFSIZE);
		}
	};
	...
	struct SNET_INVEN_SELFORMBOX_SELECTOPEN_FB : public NET_MSG_GENERIC
	{
			...
			: emFB(EMINVEN_SELFORMBOX_FB_FAIL)
		{
			...
			GASSERT(sizeof(SNET_INVEN_SELFORMBOX_SELECTOPEN_FB)<=NET_DATA_BUFSIZE);
		}
	};
	...
	struct SNET_ITEMSHOP_BUY_FB
	{
		...
		char				szName[CHAR_SZNAME+1]; //CHAR_NAME
			...
			, nID(NATIVEID_NULL())
		{
			...
			GASSERT(nmg.dwSize<=NET_DATA_BUFSIZE);
			memset ( szName, 0, sizeof(char)*(CHAR_SZNAME+1) ); //CHAR_NAME
		}
	};
...
//itemmall end
	...
	struct SNET_REBUILD_MOVE_SEAL //sealed card 
	{
		NET_MSG_GENERIC		nmg;
		...
		SNET_REBUILD_MOVE_SEAL()
			: wPosX( USHRT_MAX )
			, wPosY( USHRT_MAX )
		{
			nmg.dwSize = sizeof( SNET_REBUILD_MOVE_SEAL );
			nmg.nType = NET_MSG_REBUILD_MOVE_SEAL;
		}
	};
