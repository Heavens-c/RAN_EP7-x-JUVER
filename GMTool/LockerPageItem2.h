...
class CLockerPageItem2 : public CPropertyPage
{
	DECLARE_DYNAMIC(CLockerPageItem2)

public:
	CLockerPageItem2(LOGFONT logfont, SCHARDATA2* pData);
	virtual ~CLockerPageItem2();

// Dialog Data
	enum { IDD = IDD_LOCKER_PAGE_ITEM_2 };
