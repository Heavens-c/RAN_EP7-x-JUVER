...
int CAgentThaiUserCheck::Execute (CServer* pServer)
{
	...
	default : // 다른 모든경우 로그인 실패
		...
		//login delay
	case 30 : // EM_LOGIN_FB_SUB_REQUIRETIME
		NetMsgFB.nResult = EM_LOGIN_FB_SUB_REQUIRETIME;
		CConsoleMessage::GetInstance()->Write("CAgentThaiUserCheck result %d", nResult);
		break;
	}
...
//	NetMsgFB.nThaiCC_Class = nResult1;
	...
	case 30 : // EM_LOGIN_FB_SUB_REQUIRETIME
		...
		//PCID
	/*case 31 : // EM_LOGIN_FB_SUB_REQUIRETIME
		NetMsgFB.nResult = EM_LOGIN_FB_SUB_PCID_USED;
		CConsoleMessage::GetInstance()->Write("CAgentUserCheck result %d Duplicate PC ID", nResult);
		break;*/
	}
...
int CAgentDaumUserCheck::Execute( CServer *pServer )
{
	...
	default : // 다른 모든경우 로그인 실패
		...
		//login delay
	case 30 : // EM_LOGIN_FB_SUB_REQUIRETIME
		nlfd2.nResult = EM_LOGIN_FB_SUB_REQUIRETIME;
		CConsoleMessage::GetInstance()->Write("CAgentDaumUserCheck result %d", nResult);
		break;
	}
...
int CAgentGspUserCheck::Execute( CServer* pServer )
{
	...
	*/
	...
	case 30 : // EM_LOGIN_FB_SUB_REQUIRETIME
		nlfd2.nResult = EM_LOGIN_FB_SUB_REQUIRETIME;
		CConsoleMessage::GetInstance()->Write("CAgentGspUserCheck result %d", nResult);
		break;
	}
...
int CAgentTerraUserCheck::Execute(CServer* pServer)
{
	...
	case 30 : // EM_LOGIN_FB_SUB_REQUIRETIME
		nlfd2.nResult = EM_LOGIN_FB_SUB_REQUIRETIME;
		CConsoleMessage::GetInstance()->Write("CAgentTerraUserCheck result %d", nResult);
		break;
	}
...
{	
	...
	case 30 : // EM_LOGIN_FB_SUB_REQUIRETIME
		nlfd2.nResult = EM_LOGIN_FB_SUB_REQUIRETIME;
		CConsoleMessage::GetInstance()->Write("CAgentExciteUserCheck result %d", nResult);
		break;
	}
...
{	
	...
	case 30 : // EM_LOGIN_FB_SUB_REQUIRETIME
		nlfd2.nResult = EM_LOGIN_FB_SUB_REQUIRETIME;
		CConsoleMessage::GetInstance()->Write("CAgentJapanUserCheck result %d", nResult);
		break;
	}
