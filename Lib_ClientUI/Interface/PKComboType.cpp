...
void CPKComboType::CreateSubControl ( CString strKeyword )
{
...
void	CPKComboType::START()
{
	RESET ();
	m_bPLAY = true;
}

void	CPKComboType::RESET()
{
	m_fPlayedTime = 0.0f;
...
void CPKComboType::Update ( int x, int y, BYTE LB, BYTE MB, BYTE RB, int nScroll, float fElapsedTime, BOOL bFirstControl )
{
