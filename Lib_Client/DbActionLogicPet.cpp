...
CSetPetDualSkill::CSetPetDualSkill(
	int	nChaNum,
	int nPetNum, 
	bool bDualSkill)
	: m_nChaNum ( nChaNum )
	, m_nPetNum(nPetNum)
	, m_bDualSkill(bDualSkill)

{
}

/*dual pet skill, Juver, 2017/12/29 */
int CSetPetDualSkill::Execute(CServer* pServer)
{
	return m_pDbManager->SetPetDualSkill(m_nChaNum, m_nPetNum, m_bDualSkill);
}
...
/*dual pet skill, Juver, 2017/12/29 */
int CSetPetSkill_A::Execute(CServer* pServer)
{
	// PET 스킬 업데이트
	if (m_bActive)
	{
...
/*dual pet skill, Juver, 2017/12/29 */
int CSetPetSkill_B::Execute(CServer* pServer)
{
	// PET 스킬 업데이트
	if (m_bActive)
	{
