...
void VoidMainNews::ResetControls()
{
	...
	vm_DonationButton->SetFlip(false);
	vm_GiftCodeButton->SetFlip(false);
//gcTextBack->SetVisibleSingle(FALSE);
	//vm_GiftCodeClaimButton->SetVisibleSingle(FALSE);
			...
			if ( CHECK_MOUSEIN_LBUPLIKE ( dwMsg )  )	
				{
					...
					//vm_GiftCodeClaimButton->SetVisibleSingle(TRUE);
					m_pNewsImage6->SetVisibleSingle(TRUE);
					//gcTextBack->SetVisibleSingle(TRUE);
				}
