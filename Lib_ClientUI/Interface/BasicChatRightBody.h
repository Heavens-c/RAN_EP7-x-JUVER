...
const	int	CHAT_REGIONAL	= 0x1000;	/*regional chat, Juver, 2017/12/06 */
const	int	CHAT_ALL		= CHAT_TOALL|CHAT_SYSTEM|CHAT_NORMAL|CHAT_PRIVATE|CHAT_PARTY|CHAT_GUILD|CHAT_ALLIANCE|CHAT_REGIONAL;
...
class CBasicChatRightBody : public CUIGroup
{
	...
	static	const CString REGIONAL_SYMBOL; /*regional chat, Juver, 2017/12/06 */
...
public:
	enum
	{
		...
		CHAT_CHANNEL_SYSTEM,
		CHAT_CHANNEL_REGIONAL,		/*regional chat, Juver, 2017/12/06 */
		...
		CHAT_TEXTBOX_SYSTEM,
		CHAT_TEXTBOX_REGIONAL,		/*regional chat, Juver, 2017/12/06 */
	};
...
private:	//	전체
	...
	CBasicTextBoxEx*	m_pTextBox_REGIONAL;
	CBasicScrollBarEx*	m_pScrollBar_REGIONAL;
	CBasicTextButton*	m_pChatRegionalButton;
...
private:
	/*item link, Juver, 2017/07/31 */
	void	AddStringToNORMAL ( CString strTemp, D3DCOLOR dwColor, SITEMLINK* pItemLink );
...
public:
	// 채팅메세지를 리스트에 추가
	 /*item link, Juver, 2017/07/31 */
	void	ADD_CHATLOG ( const CString& strChat, SITEMLINK sItemLink ); 
...
private:
	...
	void	EDIT_END ();
	void	EDIT_CLEAR();	/*item link, Juver, 2017/07/31 */
...
private:
	...
	bool	SEND_REGIONAL_MESSAGE ( const CString& strOrigin );	/*regional chat, Juver, 2017/12/06 */
...
public:
	...
	/*item link, Juver, 2017/07/31 */
public:
	void	CheckItemLink( CString strText );
	void	CheckItemLink( CString strText, SITEMLINK sItemLink );
	void	CheckPreviewItemLink( CString strText, SITEMLINK sItemLink );

	/*box contents, Juver, 2017/08/30 */
	void	CheckBoxContentsItemLink( CString strText, SITEMLINK sItemLink );
...
private:
	...
	/*item link, Juver, 2017/07/31 */
	typedef	std::list<SCHATLOG>	NORMAL_CHAT_LOG;
