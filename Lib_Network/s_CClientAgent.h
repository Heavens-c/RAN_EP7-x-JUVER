...
public :
	...
	bool    IsRegister(DWORD dwClient);
	void    SetRegister(DWORD dwClient, bool bSet );
	bool    IsRegisterWait(DWORD dwClient);
	void    SetRegisterWait(DWORD dwClient, bool bSet );
