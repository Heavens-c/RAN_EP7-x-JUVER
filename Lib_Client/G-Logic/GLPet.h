...
typedef stdext::hash_map<DWORD,PETSKILL>		PETSKILL_MAP;
typedef PETSKILL_MAP::iterator					PETSKILL_MAP_ITER;
typedef PETSKILL_MAP::const_iterator			PETSKILL_MAP_CITER;

typedef stdext::hash_map<DWORD,float>			PETDELAY_MAP;
typedef PETDELAY_MAP::iterator					PETDELAY_MAP_ITER;

typedef stdext::hash_map<DWORD,PETREVIVEINFO>	PETREVIVEINFO_MAP;
...
typedef stdext::hash_map<DWORD,SPETCARDINFO>	PETCARDINFO_MAP;
...
namespace COMMENT
{
	extern std::string PET_TYPE[PET_TYPE_SIZE];
};
