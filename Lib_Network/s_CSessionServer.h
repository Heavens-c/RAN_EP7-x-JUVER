...
{
public :
	CSessionServer( HWND hWnd, HWND hEditBox, HWND hEditBoxInfo, HWND hEditBoxStats );
	~CSessionServer();
...
public:
	void IPFilterCleanIP( std::string _strIP );

	void MsgServerBroadCastIPFilterBlockAdd( MSG_LIST* _pMsg );
	void MsgServerBroadCastIPFilterBlockDel( MSG_LIST* _pMsg );
	void MsgServerBroadCastIPFilterKnownAdd( MSG_LIST* _pMsg );
	void MsgServerBroadCastIPFilterKnownDel( MSG_LIST* _pMsg );
	void MsgServerBroadCastIPFilterBlockAddSelf( std::string _strIP );
	void MsgServerBroadCastIPFilterBlockDelSelf( std::string _strIP );
	void MsgServerBroadCastIPFilterKnownAddSelf( std::string _strIP );
	void MsgServerBroadCastIPFilterKnownDelSelf( std::string _strIP );
	void IPFilterListSave();
