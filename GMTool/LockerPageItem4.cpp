// LockerPageItem4.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CLockerPageItem4, CPropertyPage)

CLockerPageItem4::CLockerPageItem4(LOGFONT logfont, SCHARDATA2* pData)
	: CPropertyPage(CLockerPageItem4::IDD)
	, m_pFont( NULL )
	, m_pData( NULL )
	, m_nLockerChannel(-1)
{
...
CLockerPageItem4::~CLockerPageItem4()
{
	SAFE_DELETE ( m_pFont );
}

void CLockerPageItem4::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CLockerPageItem4, CPropertyPage)
...
// CLockerPageItem4 message handlers
BOOL CLockerPageItem4::OnInitDialog()
{
...
void CLockerPageItem4::ShowData()
{
...
void CLockerPageItem4::EditItem()
{
	if( !m_pData ){
		return;
	}
...
void CLockerPageItem4::OnBnClickedLockerPageButtonAdd()
{
	if ( !m_pData ){
		return;
	}
...
void CLockerPageItem4::OnBnClickedLockerPageButtonEdit()
{
	EditItem();
}

void CLockerPageItem4::OnBnClickedLockerPageButtonDelete()
{
	if ( !m_pData ){
		return;
	}
...
void CLockerPageItem4::OnBnClickedLockerPageButtonClear()
{
	if ( !m_pData ){
		return;
	}
...
void CLockerPageItem4::OnNMDblclkLockerPageList(NMHDR *pNMHDR, LRESULT *pResult)
{
