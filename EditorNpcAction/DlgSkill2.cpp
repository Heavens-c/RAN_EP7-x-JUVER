// DlgSkill2.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CDlgSkill2, CDialog)

CDlgSkill2::CDlgSkill2(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgSkill2::IDD, pParent)
...
CDlgSkill2::~CDlgSkill2()
{
}

void CDlgSkill2::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDlgSkill2, CDialog)
	ON_LBN_SELCHANGE(IDC_LIST_SELECT, OnLbnSelchangeListSelect)
	ON_BN_CLICKED(IDC_BUTTON_SEARCH, OnBnClickedButtonSearch)
END_MESSAGE_MAP()


// CDlgSkill2 message handlers
BOOL CDlgSkill2::OnInitDialog()
{
...
void CDlgSkill2::SelectionReset()
{
	m_SELECTED = NATIVEID_NULL();
...
void CDlgSkill2::OnLbnSelchangeListSelect()
{
...
void CDlgSkill2::OnBnClickedButtonSearch()
{
	SearchData();
}

void CDlgSkill2::SearchData()
{
