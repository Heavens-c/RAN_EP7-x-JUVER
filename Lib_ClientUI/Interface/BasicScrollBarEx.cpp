...
void CBasicScrollBarEx::CreateBaseScrollBarBlack ( char* szBaseScrollBar, const bool& bVERTICAL )
{
	if ( bVERTICAL )
	{
		CreateThumb ( "BASIC_NEW_SCROLLBAR_THUMB_FRAME", "BASIC_NEW_SCROLLBAR_THUMB_MAIN", "BASIC_NEW_SCROLLBAR_THUMB_BODY", "BASIC_NEW_SCROLLBAR_THUMB_UP", "BASIC_NEW_SCROLLBAR_THUMB_DN", bVERTICAL );
		CreateButton ( "BASIC_NEW_SCROLLBAR_BUTTONUP", "BASIC_NEW_SCROLLBAR_BUTTONUP_F", "BASIC_NEW_SCROLLBAR_BUTTONDN", "BASIC_NEW_SCROLLBAR_BUTTONDN_F", bVERTICAL );
	}
	else
	{
		CreateThumb ( "BASIC_SCROLLBAR_THUMB_FRAME_H", "BASIC_SCROLLBAR_THUMB_MAIN_H", "BASIC_SCROLLBAR_THUMB_BODY_H", "BASIC_SCROLLBAR_THUMB_UP_H", "BASIC_SCROLLBAR_THUMB_DN_H", bVERTICAL );
...
void CBasicScrollBarEx::CreateNewBaseScrollBar ( char* szNewBaseScrollBar, const bool& bVERTICAL )
{
	if ( bVERTICAL )
	{
		CreateThumb ( "BASIC_SCROLLBAR_THUMB_FRAME", "BASIC_SCROLLBAR_THUMB_MAIN", "BASIC_NEW_SCROLLBAR_THUMB_BODY", "BASIC_NEW_SCROLLBAR_THUMB_UP", "BASIC_NEW_SCROLLBAR_THUMB_DN", bVERTICAL );
		CreateButton ( "BASIC_NEW_SCROLLBAR_BUTTONUP", "BASIC_NEW_SCROLLBAR_BUTTONUP_F", "BASIC_NEW_SCROLLBAR_BUTTONDN", "BASIC_NEW_SCROLLBAR_BUTTONDN_F", bVERTICAL );
	}
	else
	{
    ...
    CUIControl TempControl;
	TempControl.Create ( 1, szNewBaseScrollBar );
	const UIRECT& rcParentOldPos = GetLocalPos ();
	const UIRECT& rcParentNewPos = TempControl.GetLocalPos ();
	AlignSubControl ( rcParentOldPos, rcParentNewPos );
