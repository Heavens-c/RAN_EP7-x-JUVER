// LockerPageItem1.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CLockerPageItem1, CPropertyPage)

CLockerPageItem1::CLockerPageItem1(LOGFONT logfont, SCHARDATA2* pData)
	: CPropertyPage(CLockerPageItem1::IDD)
	, m_pFont( NULL )
	, m_pData( NULL )
	, m_nLockerChannel(-1)
{
...
CLockerPageItem1::~CLockerPageItem1()
{
	SAFE_DELETE ( m_pFont );
}

void CLockerPageItem1::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CLockerPageItem1, CPropertyPage)
...
// CLockerPageItem1 message handlers
BOOL CLockerPageItem1::OnInitDialog()
{
...
void CLockerPageItem1::ShowData()
{
...
void CLockerPageItem1::EditItem()
{
	if( !m_pData ){
		return;
	}
...
void CLockerPageItem1::OnBnClickedLockerPageButtonAdd()
{
	if ( !m_pData ){
		return;
	}
...
void CLockerPageItem1::OnBnClickedLockerPageButtonEdit()
{
	EditItem();
}

void CLockerPageItem1::OnBnClickedLockerPageButtonDelete()
{
	if ( !m_pData ){
		return;
	}
...
void CLockerPageItem1::OnBnClickedLockerPageButtonClear()
{
	if ( !m_pData ){
		return;
	}
...
void CLockerPageItem1::OnNMDblclkLockerPageList(NMHDR *pNMHDR, LRESULT *pResult)
{
