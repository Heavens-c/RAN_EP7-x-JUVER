...
public:
	...
	HRESULT RenderGenPos ( LPDIRECT3DDEVICEQ pd3dDevice, DWORD dwRenderColor = 0xffffffff );
	HRESULT Render ( LPDIRECT3DDEVICEQ pd3dDevice, CLIPVOLUME &cv, DWORD dwRenderColor = 0xffffffff );
...
typedef stdext::hash_map<DWORD,GLMOBGROUB>	MAPMOBGROUB;
...
{
public:
	typedef stdext::hash_set<DWORD>				MOBDESC;
	typedef stdext::hash_set<DWORD>::iterator	MOBDESC_ITER;
