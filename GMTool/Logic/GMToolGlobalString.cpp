...
namespace GMTOOL_GLOBAL
{
	...
	std::string	strEquipmentLockPageSearchType[EMEQUIPMENT_LOCK_PAGE_SEARCH_TYPE_SIZE] =
	{
		_T("Search ChaNum"),
		_T("Search ChaName"),
		_T("Search EquipmentPass"),
	};

	/*inventory lock, DevArt22, 2021/04/09 */
	std::string	strInventoryLockPageSearchType[EMINVENTORY_LOCK_PAGE_SEARCH_TYPE_SIZE] =
	{
		_T("Search ChaNum"),
		_T("Search ChaName"),
		_T("Search InventoryPass"),
	};

	/*storage lock, DevArt22, 2021/04/09 */
	std::string	strStorageLockPageSearchType[EMSTORAGE_LOCK_PAGE_SEARCH_TYPE_SIZE] =
	{
		_T("Search ChaNum"),
		_T("Search ChaName"),
		_T("Search StoragePass"),
	};
};
