...
#if defined ( HK_PARAM ) || defined ( TW_PARAM ) // Apex ����( ȫ�� )
	NET_APEX_RETURN nmg;
	nmg.nReturn = nReturn;
...
void DxGlobalStage::MsgProcessFrame ( NET_MSG_GENERIC *nmg )
{
	...
	case NET_MSG_GCTRL_REQ_RANKNAME_BRD: //MMR Rank
	case NET_MSG_GCTRL_REQ_RANKMARK_BRD: //MMR Rank
	...
	/////////////////////////////////////////////////////////////////////////////
	/*selective form box, emmcatap, 3-10-2022*/
