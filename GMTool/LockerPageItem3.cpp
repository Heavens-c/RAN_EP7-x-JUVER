// LockerPageItem3.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CLockerPageItem3, CPropertyPage)

CLockerPageItem3::CLockerPageItem3(LOGFONT logfont, SCHARDATA2* pData)
	: CPropertyPage(CLockerPageItem3::IDD)
	, m_pFont( NULL )
	, m_pData( NULL )
	, m_nLockerChannel(-1)
{
...
CLockerPageItem3::~CLockerPageItem3()
{
	SAFE_DELETE ( m_pFont );
}

void CLockerPageItem3::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CLockerPageItem3, CPropertyPage)
...
// CLockerPageItem3 message handlers
BOOL CLockerPageItem3::OnInitDialog()
{
...
void CLockerPageItem3::ShowData()
{
...
void CLockerPageItem3::EditItem()
{
	if( !m_pData ){
		return;
	}
...
void CLockerPageItem3::OnBnClickedLockerPageButtonAdd()
{
	if ( !m_pData ){
		return;
	}
...
void CLockerPageItem3::OnBnClickedLockerPageButtonEdit()
{
	EditItem();
}

void CLockerPageItem3::OnBnClickedLockerPageButtonDelete()
{
	if ( !m_pData ){
		return;
	}
...
void CLockerPageItem3::OnBnClickedLockerPageButtonClear()
{
	if ( !m_pData ){
		return;
	}
...
void CLockerPageItem3::OnNMDblclkLockerPageList(NMHDR *pNMHDR, LRESULT *pResult)
{
