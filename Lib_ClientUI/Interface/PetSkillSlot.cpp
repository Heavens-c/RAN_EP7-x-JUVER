...
void CPetSkillSlot::CreateSubControl ( SNATIVEID sNativeID )
{
	...
	CreateControl ( "PET_SKILL_SLOT_BACK_SKILL_IMAGE" );
    CreateControl ( "PET_SKILL_SLOT_BACK_SKILL_TEXT_L" );	
	CreateControl ( "PET_SKILL_SLOT_BACK_SKILL_TEXT_M" );
	CreateControl ( "PET_SKILL_SLOT_BACK_SKILL_TEXT_R" );
...
//		GASSERT ( 0 && "무효화한 ID 입니다. 확인하십시오." );
	...
	else
	{
		...
		m_pNotLearnImage = CreateControl ( "PET_SKILL_SLOT_IMAGE_NOTLEARN" );

		m_pTextBox = CreateStaticControl ( "PET_SKILL_SLOT_TEXT", pFont, dwColor, nTextAlign );			
...
CPetSkillImage* CPetSkillSlot::CreateSkillImage ()
{
	...
	pSkillImage->CreateSub ( this, "PET_SKILL_SLOT_IMAGE", UI_FLAG_DEFAULT, SKILL_SLOT_IMAGE );
