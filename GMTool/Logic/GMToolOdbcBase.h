...
public:
	/*inventory lock, DevArt22, 2021/04/09 */
	int InventoryLock_Find( const char* szSQL, SGMTOOL_INVENTORY_LOCK_DATA_SIMPLE_MAP &mapResult );
	int InventoryLock_Find_ChaNum( int nChaNum, SGMTOOL_INVENTORY_LOCK_DATA_SIMPLE_MAP &mapResult, int nLIMITNUM );
	int InventoryLock_Find_ChaName( std::string strChaName, SGMTOOL_INVENTORY_LOCK_DATA_SIMPLE_MAP &mapResult, int nLIMITNUM );
	int InventoryLock_Find_EPin( std::string strEPin, SGMTOOL_INVENTORY_LOCK_DATA_SIMPLE_MAP &mapResult, int nLIMITNUM );
	int InventoryLock_Delete( int nNum );
	int InventoryLock_Delete_To_Char( int nNum );
	int InventoryLock_Get( int nNUM, SGMTOOL_INVENTORY_LOCK_DATA_SIMPLE* pDATA );
	int InventoryLock_Save( SGMTOOL_INVENTORY_LOCK_DATA_SIMPLE* pDATA );
	int InventoryLock_New( SGMTOOL_INVENTORY_LOCK_DATA_SIMPLE* pDATA );

public:
	/*storage lock, DevArt22, 2021/04/09 */
	int StorageLock_Find( const char* szSQL, SGMTOOL_STORAGE_LOCK_DATA_SIMPLE_MAP &mapResult );
	int StorageLock_Find_ChaNum( int nChaNum, SGMTOOL_STORAGE_LOCK_DATA_SIMPLE_MAP &mapResult, int nLIMITNUM );
	int StorageLock_Find_ChaName( std::string strChaName, SGMTOOL_STORAGE_LOCK_DATA_SIMPLE_MAP &mapResult, int nLIMITNUM );
	int StorageLock_Find_EPin( std::string strEPin, SGMTOOL_STORAGE_LOCK_DATA_SIMPLE_MAP &mapResult, int nLIMITNUM );
	int StorageLock_Delete( int nNum );
	int StorageLock_Delete_To_Char( int nNum );
	int StorageLock_Get( int nNUM, SGMTOOL_STORAGE_LOCK_DATA_SIMPLE* pDATA );
	int StorageLock_Save( SGMTOOL_STORAGE_LOCK_DATA_SIMPLE* pDATA );
	int StorageLock_New( SGMTOOL_STORAGE_LOCK_DATA_SIMPLE* pDATA );
};
