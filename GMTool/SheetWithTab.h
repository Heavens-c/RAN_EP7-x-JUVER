...
#include "PageInventoryLock.h" /*inventory lock, DevArt22, 2021/04/09 */
#include "PageStorageLock.h" /*storage lock, DevArt22, 2021/04/09 */
#include "PagePet.h"
...
public:
	...
	CPageInventoryLock	m_PageInventoryLock; /*inventory lock, DevArt22, 2021/04/09 */
	CPageStorageLock	m_PageStorageLock; /*storage lock, DevArt22, 2021/04/09 */
	CPagePet		m_PagePet;
