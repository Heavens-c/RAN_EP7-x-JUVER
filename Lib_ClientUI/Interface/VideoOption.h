...
protected:
	enum
	{
		...
		HWOPTION_VIDEO_TEXTUREFILTER_COMBO_OPEN,
		HWOPTION_VIDEO_TEXTUREFILTER_COMBO_ROLLOVER,
	};
...
private:
	...
	void	SetTextTextureFilterCombo( DWORD dwIndex );
...
private:
	...
	CBasicComboBox*			m_pComboBoxTextureFilterOpen;
	CBasicComboBoxRollOver*	m_pComboBoxTextureFilterRollOver;
