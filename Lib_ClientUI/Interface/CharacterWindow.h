...
private:	//	Status
	...
	void	SetCP ( const GLCHARLOGIC& sCharData ); /*combatpoint logic, Juver, 2017/05/29 */
...
public:
	...
	void	SetActivitySystemPoint( const GLCHARLOGIC& sCharData ); 
...
public:
	...
	void	LoadPKInfo( const GLCHARLOGIC& sCharData );
...
private:	//	사회 성향
	...
	/*contribution point, Juver, 2017/08/23 */
	CBasicTextBox*	m_pContributionPoint;

	/*activity point, Juver, 2017/08/23 */
	CBasicTextBox*	m_pExtraActivityPoint;
