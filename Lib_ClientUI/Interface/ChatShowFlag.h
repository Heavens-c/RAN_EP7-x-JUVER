...
const DWORD UIMSG_CHAT_REGIONAL	= UIMSG_USER7; /*regional chat, Juver, 2017/12/06 */
...
private:
	enum
	{
		...
		CHAT_ALLIANCE_CHECK,
		CHAT_SYSTEM_CHECK,
		CHAT_REGIONAL_CHECK, /*regional chat, Juver, 2017/12/06 */
		...
		CHAT_SYSTEM_TEXTBOX,
		CHAT_REGIONAL_TEXTBOX /*regional chat, Juver, 2017/12/06 */
	};
...
private:
	...
	CBasicButton*	m_pRegionalButton;		/*regional chat, Juver, 2017/12/06 */
	...
	CBasicTextBox*	m_pRegionalTextBox;		/*regional chat, Juver, 2017/12/06 */
};