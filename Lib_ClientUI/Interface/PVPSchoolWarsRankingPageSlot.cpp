...
CPVPSchoolWarsRankingPageSlot::CPVPSchoolWarsRankingPageSlot ()
	: m_pTextRank(NULL)
	, m_pTextName(NULL)
	, m_pTextKill(NULL)
	, m_pTextDeath(NULL)
...
void CPVPSchoolWarsRankingPageSlot::CreateSubControl( BOOL bSelf )
{
	m_bSelf = bSelf;
	...
	m_pTextKill->CreateSub ( this, "SCHOOLWARS_RESULT_TEXT_BASE_KILL" );
	...
	m_pTextDeath->CreateSub ( this, "SCHOOLWARS_RESULT_TEXT_BASE_DEATH" );
	...
	m_pTextResu->CreateSub ( this, "SCHOOLWARS_RESULT_TEXT_BASE_REBIRTH" );
	...
	m_pTextHeal->CreateSub ( this, "SCHOOLWARS_RESULT_TEXT_BASE_HEAL" );
	...
	m_pTextScore->CreateSub ( this, "SCHOOLWARS_RESULT_TEXT_BASE_SCORE" );
	...
	m_pTextPoint->CreateSub ( this, "SCHOOLWARS_RESULT_TEXT_BASE_CONTRIBUTION" );
...
void CPVPSchoolWarsRankingPageSlot::ResetData()
{
...
void CPVPSchoolWarsRankingPageSlot::SetData( SCHOOLWARS_PLAYER_DATA* pData, BOOL bTotal )
{
	ResetData();
