	...
	case WM_KEYDOWN:
		{
			if ( pMsg->wParam == VK_ESCAPE )
			{
				...
				{
					m_PageEdit1.ItemClear();
					m_PageEdit2.ItemClear ();
...
void CsheetWithTab::ActivePageEdit1( int nCurPage, SITEM* pItem )
{
	m_PageEdit1.SetCallPage( nCurPage );
	m_PageEdit1.ItemSet( pItem );
	SetActivePage ( PAGE_EDIT1 );
}

void CsheetWithTab::ActivePageEdit2( int nCurPage, SITEM* pItem )
{
	m_PageEdit2.SetCallPage( nCurPage );
	m_PageEdit2.ItemSet( pItem );
