...
void  CBasicQuickPotionSlotEx::CreateSubControl ( int nIndex )
{
	...
	CreateBlockImage ( "QUICK_POTION_BLOCK_IMAGE" );	 /*prohibit potion skill logic, Juver, 2017/06/06 */
	m_pPotionMouseOver->SetVisibleSingle ( FALSE );
	m_pBlockImage->SetVisibleSingle ( FALSE ); /*prohibit potion skill logic, Juver, 2017/06/06 */
