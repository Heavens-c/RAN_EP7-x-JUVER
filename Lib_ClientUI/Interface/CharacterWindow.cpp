...
CCharacterWindow::CCharacterWindow () :
	...
	m_pMPText ( NULL ),
	m_pSPText ( NULL ),
	m_pCPText ( NULL ), /*combatpoint logic, Juver, 2017/05/29 */
	m_pHitRateText ( NULL ),
	...
	m_pContributionPoint(NULL),

	/*activity point, Juver, 2017/08/23 */
	m_pExtraActivityPoint(NULL),
...
void CCharacterWindow::CreateSubControl ()
{
	...
	{	//	Status
		...
		pTextBox->AddText ( ID2GAMEWORD("CHARACTER_STATUS_STATIC", 13), dwSilver );
		...
		m_pCPText = CreateStaticControl ( "CHARACTER_CP_TEXT", pFont8Shadow, nAlignLeft ); /*combatpoint logic, Juver, 2017/05/29 */
	...
	{	//	사회성향
		...
		/*activity point, Juver, 2017/08/23 */
		pTextBox = CreateStaticControl ( "CHARACTER_ACTIVITY_STATIC", pFont, nAlignLeft );
		pTextBox->AddText ( ID2GAMEWORD("CHARACTER_SOCIAL_STATIC2", 0), dwSilver );

		/*pk info, Juver, 2017/11/17 */
		pTextBox = CreateStaticControl ( "CHARACTER_PK_SCORE_STATIC", pFont, nAlignLeft );
		pTextBox->AddText ( ID2GAMEWORD("CHARACTER_SOCIAL_STATIC2", 1), dwSilver );
		pTextBox = CreateStaticControl ( "CHARACTER_PK_DEATH_STATIC", pFont, nAlignLeft );
		pTextBox->AddText ( ID2GAMEWORD("CHARACTER_SOCIAL_STATIC2", 2), dwSilver );
		...
		/*contribution point, Juver, 2017/08/23 */
		m_pContributionPoint = CreateStaticControl ( "CHARACTER_CONTRIBUTION_TEXT", pFont, nAlignLeft );

		/*activity point, Juver, 2017/08/23 */
		m_pExtraActivityPoint = CreateStaticControl ( "CHARACTER_ACTIVITY_TEXT", pFont, nAlignLeft );

		/*pk info, Juver, 2017/11/17 */
		m_pPKScore = CreateStaticControl ( "CHARACTER_PK_SCORE_TEXT", pFont, nAlignLeft );
		m_pPKDeath = CreateStaticControl ( "CHARACTER_PK_DEATH_TEXT", pFont, nAlignLeft );
