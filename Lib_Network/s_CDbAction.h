 ...
 */
//userpanel
class CAgentUserResetPassword : public CDbAction
{
public:
	CAgentUserResetPassword(
		const TCHAR* szUserID, // ID 
		const TCHAR* szPasswd2, // PWD
		const TCHAR* szCaptcha,
		DWORD dwClientNum);
	virtual ~CAgentUserResetPassword() {} ;
	virtual int Execute(CServer* pServer);
...
class CAgentUserResetPassword2 : public CDbAction
{
public:
	CAgentUserResetPassword2(
		const TCHAR* szUserID, // ID 
		const TCHAR* szPasswd, // PWD
		const TCHAR* szPasswd2, // PWD
		const TCHAR* szCaptcha,
		DWORD dwClientNum);
	virtual ~CAgentUserResetPassword2() {} ;
	virtual int Execute(CServer* pServer);
...
class CAgentUserResetPin : public CDbAction
{
public:
	CAgentUserResetPin(
		const TCHAR* szUserID, // ID 
		const TCHAR* szEmail, // EM
		const TCHAR* szPasswd, // PWD
		const TCHAR* szPasswd2, // PWD
		const TCHAR* szPasswd2Hold, // PWD
		const TCHAR* szCaptcha,
		DWORD dwClientNum);
	virtual ~CAgentUserResetPin() {} ;
	virtual int Execute(CServer* pServer);
...
protected:
	...
	CString m_strPasswd;
	CString m_strPasswd2;
	CString m_strPasswd2Hold;
	CString m_strCaptcha;
	DWORD	m_dwClientNum;
};

class CAgentUserChangePassword : public CDbAction
{
public:
	CAgentUserChangePassword(
		const TCHAR* szUserID, // ID 
		const TCHAR* szOPasswd, // PWD
		const TCHAR* szPasswd, // PWD
		const TCHAR* szPasswd2, // PWD
		const TCHAR* szCaptcha,
		DWORD dwClientNum);
	virtual ~CAgentUserChangePassword() {} ;
	virtual int Execute(CServer* pServer);

protected:
	CString m_strUserID;
	CString m_strOPasswd;
	CString m_strPasswd;
	CString m_strPasswd2;
	CString m_strCaptcha;
	DWORD	m_dwClientNum;
};
class CAgentUserChangePin : public CDbAction
{
public:
	CAgentUserChangePin(
		const TCHAR* szUserID, // ID 
		const TCHAR* szOPasswd2, // PWD
		const TCHAR* szPasswd, // PWD
		const TCHAR* szPasswd2, // PWD
		const TCHAR* szCaptcha,
		DWORD dwClientNum);
	virtual ~CAgentUserChangePin() {} ;
	virtual int Execute(CServer* pServer);

protected:
	CString m_strUserID;
	CString m_strOPasswd2;
	CString m_strPasswd;
	CString m_strPasswd2;
	CString m_strCaptcha;
	DWORD	m_dwClientNum;
};
class CAgentUserChangeEmail : public CDbAction
{
public:
	CAgentUserChangeEmail(
		const TCHAR* szUserID, // ID 
		const TCHAR* szPasswd, // PWD
		const TCHAR* szPasswd2, // PWD
		const TCHAR* szCaptcha,
...
class CAgentUserTopUp : public CDbAction
{
public:
	CAgentUserTopUp(
		const TCHAR* szUserID, // ID 
		const TCHAR* szCode, // PWD
		const TCHAR* szPin, // PWD
		const TCHAR* szCaptcha,
		DWORD dwClientNum);
	virtual ~CAgentUserTopUp() {} ;
	virtual int Execute(CServer* pServer);
...
class CAgentUserGameTimeCVT : public CDbAction
{
public:
	CAgentUserGameTimeCVT(
		const TCHAR* szUserID, // ID 
		const TCHAR* szCaptcha,
		DWORD dwGameTime,
		DWORD dwClientNum);
	virtual ~CAgentUserGameTimeCVT() {} ;
	virtual int Execute(CServer* pServer);
...
class CAgentUserPremiumPointCVT : public CDbAction
{
public:
	CAgentUserPremiumPointCVT(
		const TCHAR* szUserID, // ID 
		const TCHAR* szValue,
		const TCHAR* szCaptcha,
		DWORD dwClientNum);
	virtual ~CAgentUserPremiumPointCVT() {} ;
	virtual int Execute(CServer* pServer);
...
class CAgentUserCharSelectPass : public CDbAction
{
public:
	CAgentUserCharSelectPass(
		const TCHAR* szUserID, // ID 
		const TCHAR* szPass, // PWD
		DWORD dwClientNum);
	virtual ~CAgentUserCharSelectPass() {} ;
	virtual int Execute(CServer* pServer);
...
class CAgentUserRegister : public CDbAction
{
public:
	CAgentUserRegister(
		const TCHAR* szUser,
	...
	virtual ~CAgentUserRegister() {} ;
	virtual int Execute(CServer* pServer);

protected:
	char  m_szUser[USR_ID_LENGTH];
	char  m_szPass[USR_PASS_LENGTH];
	char  m_szPass2[USR_PASS_LENGTH];
	char  m_szSA[USR_PASS_LENGTH];
	char  m_szMail[USR_INFOMAIL_LENGTH];
