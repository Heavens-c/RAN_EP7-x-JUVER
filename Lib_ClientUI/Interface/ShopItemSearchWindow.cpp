...
void CShopItemSearchWindow::ReqSearch()
{
	if( m_pItemNameEdit->GetEditLength( ITEMSHOPSEARCH_EDIT ) != 0 )
	{
		...
		if( nIndex != 0 && nIndex != -1 )
		{
			...
			{
			case 1:
				NetMsg.sSearchData.dwReqCharClass = GLCC_BRAWLER_M;
				break;
			case 2:
				NetMsg.sSearchData.dwReqCharClass = GLCC_SWORDSMAN_M;
				break;
			case 3:
				NetMsg.sSearchData.dwReqCharClass = GLCC_SHAMAN_W;
				break;
			case 4:
			...
			case 5:
				...
				break;
			case 6:
				NetMsg.sSearchData.dwReqCharClass = GLCC_GUNNER_M;
				break;
			case 7:
