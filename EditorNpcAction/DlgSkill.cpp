...
BOOL CDlgSkill::OnInitDialog()
{
	...
	SetWin_Combo_Init( this, IDC_COMBO_LEVEL, COMMENT::SKILL_LEVEL, SKILL::MAX_LEVEL );
	SetWin_Num_int( this, IDC_EDIT_SEL_LEVEL, m_wSELECTEDLEVEL );
...
void CDlgSkill::OnCbnSelchangeComboLevel()
{
	m_wSELECTEDLEVEL = (WORD)GetWin_Combo_Sel( this, IDC_COMBO_LEVEL ) + 1; 
	SetWin_Num_int( this, IDC_EDIT_SEL_LEVEL, m_wSELECTEDLEVEL );
}
