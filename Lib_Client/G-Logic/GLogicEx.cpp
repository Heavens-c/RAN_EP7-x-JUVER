...
EMANI_MAINTYPE CHECK_VEHICLE_MAIN( SNATIVEID sVehicleID )
{
	...
	if ( pItem->sVehicle.emVehicleType == VEHICLE_TYPE_BIKE )
	{
		...
		{
		case VEHICLE_SUBTYPE_00:		return	AN_BIKE_A;
		case VEHICLE_SUBTYPE_01:		return	AN_BIKE_B;
		case VEHICLE_SUBTYPE_02:		return	AN_BIKE_C;
		case VEHICLE_SUBTYPE_03:		return	AN_BIKE_EV1;
		default:	return AN_NONE;
		};
	}
	/* vehicle car, cart, Juver, 2018/02/13 */
	else if ( pItem->sVehicle.emVehicleType == VEHICLE_TYPE_CAR )
	{
		switch ( pItem->sVehicle.emVehicleSubType )
		{
		case VEHICLE_SUBTYPE_00:	return	AN_CAR_A;
		default:	return AN_NONE;
		};
	}
	/* vehicle car, cart, Juver, 2018/02/13 */
	else if ( pItem->sVehicle.emVehicleType == VEHICLE_TYPE_CART )
	{
		switch ( pItem->sVehicle.emVehicleSubType )
		{
		case VEHICLE_SUBTYPE_00:	return	AN_REARCAR_A;
		default:	return AN_NONE;
		};
	}
...
/*vehicle system, Juver, 2017/08/07 */
EMANI_SUBTYPE CHECK_VEHICLE_SUB( EMANI_MAINTYPE enCharMainAni, bool bPassenger /*= FALSE*/ )
{
	switch ( enCharMainAni )
	{
	case AN_PLACID:	return bPassenger ? AN_SUB_VEHICLE_02_STAY:AN_SUB_VEHICLE_01_STAY;		break;
	case AN_RUN:	return bPassenger ? AN_SUB_VEHICLE_02_RUN:AN_SUB_VEHICLE_01_RUN;		break;
	case AN_WALK:	return bPassenger ? AN_SUB_VEHICLE_02_WALK:AN_SUB_VEHICLE_01_WALK;		break;
	case AN_DIE:	return bPassenger ? AN_SUB_VEHICLE_02_DEATH:AN_SUB_VEHICLE_01_DEATH;	break;
	case AN_ATTACK:	return bPassenger ? AN_SUB_VEHICLE_02_BOOST:AN_SUB_VEHICLE_01_BOOST;	break;
	default:	return AN_SUB_NONE;	break;
	};
