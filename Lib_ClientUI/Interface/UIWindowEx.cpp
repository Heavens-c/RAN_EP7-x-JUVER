...
void CUIWindowEx::CreateBaseNewWindow ( char* szWindowKeyword, char* szWindowName )
{
	CreateTitle ( "BASIC_NEW_WINDOW_TITLE", "BASIC_NEW_WINDOW_TITLE_LEFT", "BASIC_NEW_WINDOW_TITLE_MID", "BASIC_NEW_WINDOW_TITLE_RIGHT", "BASIC_NEW_WINDOW_TEXTBOX", szWindowName );

#if defined(KRT_PARAM) || defined(KR_PARAM) || defined(TW_PARAM) || defined(JP_PARAM) || defined(CH_PARAM) || defined ( HK_PARAM ) 
	CreateTitleFocus ( "BASIC_NEW_WINDOW_TITLE", "BASIC_NEW_WINDOW_TITLE_LEFT_F", "BASIC_NEW_WINDOW_TITLE_MID_F", "BASIC_NEW_WINDOW_TITLE_RIGHT_F", "BASIC_NEW_WINDOW_TEXTBOX", szWindowName );
#endif

	CreateCloseButton ( "BASIC_NEW_WINDOW_CLOSE", "BASIC_NEW_WINDOW_CLOSE_F", "BASIC_NEW_WINDOW_CLOSE_OVER" );
	CreateBody ( "BASIC_NEW_WINDOW_BODY", "BASIC_NEW_WINDOW_BODY_LEFT", "BASIC_NEW_WINDOW_BODY_UP", "BASIC_NEW_WINDOW_BODY_MAIN", "BASIC_NEW_WINDOW_BODY_DOWN", "BASIC_NEW_WINDOW_BODY_RIGHT" );
	ResizeControl ( szWindowKeyword );
...
void CUIWindowEx::CreateBaseNewWindowNoTitle ( char* szWindowKeyword )
{
	CreateTitle ( "BASIC_NEW_WINDOW_TITLE", "BASIC_NEW_WINDOW_TITLE_LEFT", "BASIC_NEW_WINDOW_TITLE_MID", "BASIC_NEW_WINDOW_TITLE_RIGHT", "BASIC_NEW_WINDOW_TEXTBOX", "" );

#if defined(KRT_PARAM) || defined(KR_PARAM) || defined(TW_PARAM) || defined(JP_PARAM) || defined(CH_PARAM) || defined ( HK_PARAM ) 
	CreateTitleFocus ( "BASIC_NEW_WINDOW_TITLE", "BASIC_NEW_WINDOW_TITLE_LEFT_F", "BASIC_NEW_WINDOW_TITLE_MID_F", "BASIC_NEW_WINDOW_TITLE_RIGHT_F", "BASIC_NEW_WINDOW_TEXTBOX", "" );
#endif
