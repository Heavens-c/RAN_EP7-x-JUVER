...
private:
	...
	BOOL MsgDropCharFromField ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID );
	BOOL MsgReqCloseClientAgt(NET_MSG_GENERIC* nmg);
	...
	/////////////////////////////////////////////////////////////////////////////
	// LG-7 CharView
	BOOL MsgReqCharView(NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID);
	BOOL MsgReqCharViewFLD(NET_MSG_GENERIC* nmg);
	/////////////////////////////////////////////////////////////////////////////

	//fastrevive fix
	BOOL MsgDeathTimerAG ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID );
	...
	BOOL MsgGmCharGetProc ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID );
	BOOL MsgGmCharGetProcUpdate ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID );
	BOOL MsgGmCharGetProcUpdateComplete ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID );
