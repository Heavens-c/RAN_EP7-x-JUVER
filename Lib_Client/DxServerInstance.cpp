...
namespace DxFieldInstance
{
					 ...
					 DWORD dwLangSet )
	{
		...
		/*pvp tyranny, Juver, 2017/08/24 */
		GLPVPTyrannyField::GetInstance().LoadEvent( GLCONST_CHAR::strTyrannyFile );

		/*school wars, Juver, 2018/01/19 */
		GLPVPSchoolWarsField::GetInstance().LoadEvent( GLCONST_CHAR::strSchoolWarsFile );

		/*pvp capture the flag, Juver, 2018/01/24 */
		GLPVPCaptureTheFlagField::GetInstance().LoadEvent( GLCONST_CHAR::strCaptureTheFlagFile );
	...
	HRESULT FrameMove ()
	{
		...
		/*pvp tyranny, Juver, 2017/08/24 */
		GLPVPTyrannyField::GetInstance().FrameMove ( fElapsedAppTime );

		/*school wars, Juver, 2018/01/19 */
		GLPVPSchoolWarsField::GetInstance().FrameMove ( fElapsedAppTime );

		/*pvp capture the flag, Juver, 2018/01/24 */
		GLPVPCaptureTheFlagField::GetInstance().FrameMove ( fElapsedAppTime );
...
namespace DxAgentInstance
{
					 ...
					 DWORD dwLangSet )
	{
		...
		/*pvp tyranny, Juver, 2017/08/24 */
		GLPVPTyrannyAgent::GetInstance().LoadEvent( GLCONST_CHAR::strTyrannyFile );

		/*school wars, Juver, 2018/01/19 */
		GLPVPSchoolWarsAgent::GetInstance().LoadEvent( GLCONST_CHAR::strSchoolWarsFile );

		/*pvp capture the flag, Juver, 2018/01/24 */
		GLPVPCaptureTheFlagAgent::GetInstance().LoadEvent( GLCONST_CHAR::strCaptureTheFlagFile );
	...
	HRESULT FrameMove()
	{
		...
		/*pvp tyranny, Juver, 2017/08/24 */
		GLPVPTyrannyAgent::GetInstance().FrameMove ( fElapsedAppTime );

		/*school wars, Juver, 2018/01/19 */
		GLPVPSchoolWarsAgent::GetInstance().FrameMove ( fElapsedAppTime );

		/*pvp capture the flag, Juver, 2018/01/24 */
		GLPVPCaptureTheFlagAgent::GetInstance().FrameMove ( fElapsedAppTime );
