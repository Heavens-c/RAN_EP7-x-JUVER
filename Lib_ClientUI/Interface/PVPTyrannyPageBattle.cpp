...
void CPVPTyrannyPageBattle::CreateSubControl ()
{
	...
	m_pTextBattleTitleStatic->AddText( ID2GAMEWORD( "COMPETITION_CTF_BATTLE_STATIC", 0 ), NS_UITEXTCOLOR::WHITE );
	m_pTextBattleTimeStartStatic->AddText( ID2GAMEWORD( "COMPETITION_CTF_BATTLE_STATIC", 1 ), NS_UITEXTCOLOR::WHITE );
	m_pTextBattleTimeEndStatic->AddText( ID2GAMEWORD( "COMPETITION_CTF_BATTLE_STATIC", 2 ), NS_UITEXTCOLOR::WHITE );
	m_pTextBattleProgressStatic->AddText( ID2GAMEWORD( "COMPETITION_CTF_BATTLE_STATIC", 3 ), NS_UITEXTCOLOR::WHITE );
	m_pTextBattleStatusStatic->AddText( ID2GAMEWORD( "COMPETITION_CTF_BATTLE_STATIC", 4 ), NS_UITEXTCOLOR::WHITE );
	...
	m_pTextBattleStatus = CreateUITextBox( "COMPETITION_CTF_PAGE_BATTLE_STATUS_TEXT", pFont9, TEXT_ALIGN_CENTER_X | TEXT_ALIGN_CENTER_Y );
