...
enum EMINVENTORY_LOCK_PAGE_SEARCH_TYPE
{
	EMINVENTORY_LOCK_PAGE_SEARCH_TYPE_CHANUM	= 0,
	EMINVENTORY_LOCK_PAGE_SEARCH_TYPE_CHANAME	= 1,
	EMINVENTORY_LOCK_PAGE_SEARCH_TYPE_EPIN		= 2,
	EMINVENTORY_LOCK_PAGE_SEARCH_TYPE_SIZE		= 3
};
enum EMSTORAGE_LOCK_PAGE_SEARCH_TYPE
{
	EMSTORAGE_LOCK_PAGE_SEARCH_TYPE_CHANUM		= 0,
	EMSTORAGE_LOCK_PAGE_SEARCH_TYPE_CHANAME		= 1,
	EMSTORAGE_LOCK_PAGE_SEARCH_TYPE_EPIN		= 2,
	EMSTORAGE_LOCK_PAGE_SEARCH_TYPE_SIZE		= 3
};
namespace GMTOOL_GLOBAL
{
	...
	extern std::string strInventoryLockPageSearchType[EMINVENTORY_LOCK_PAGE_SEARCH_TYPE_SIZE]; /*inventory lock, DevArt22, 2021/04/09 */
	extern std::string strStorageLockPageSearchType[EMSTORAGE_LOCK_PAGE_SEARCH_TYPE_SIZE]; /*storage lock, DevArt22, 2021/04/09 */
};
