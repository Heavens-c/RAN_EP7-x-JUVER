...
enum EMPMARKET_OPEN_FB
{
	...
	EMPMARKET_OPEN_FB_NOMAP			= 5,	/* map private market setting, Juver, 2017/10/02 */
	EMPMARKET_OPEN_FB_NOTALLOWED	= 6,	/*private market set, Juver, 2018/01/02 */
};
...
namespace GLMSG
{
	...
	struct SNETPC_PMARKET_SEARCH_ITEM_RESULT
	{
		NET_MSG_GENERIC		nmg;
		DWORD				dwSearchNum;
		SSEARCHITEMRESULT	sSearchResult[MAX_SEARCH_RESULT];
		DWORD				dwPageNum;
