...
class CPVPSchoolWarsPageBattle : public CUIGroup
{
private:
	enum
	{
		SCHOOLWARS_PAGE_INFO_BATTLE_BUTTON_REGISTER = NO_ID + 1,
	};

public:
	CPVPSchoolWarsPageBattle ();
	virtual	~CPVPSchoolWarsPageBattle ();
