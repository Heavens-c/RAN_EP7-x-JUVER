...
int CNetClient::SndCharSelectPass( const TCHAR* szPass )
{

	CHINA_NET_CHARSELECT_PASS_DATA nld;

	StringCchCopy( nld.szPass, USR_PASS_LENGTH, szPass );
	
	m_Tea.encrypt( nld.szPass, USR_PASS_LENGTH );
